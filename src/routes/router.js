...
export default class Router {
	...
	delete( path, cache, ...callbacks ) {
		if( !cache )
			this.router.delete( path, this._bindCustomResponses, this._getCallbacks( callbacks ) );
		else
			this.router.delete( path, this.cache( cache ), this._bindCustomResponses, this._getCallbacks( callbacks ) );
	}
